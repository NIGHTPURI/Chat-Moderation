...
/** Frozen Phase 3.15 routing policy. It selects candidates and never decides semantic action. */
final class ConfidenceAwareSemanticGate {
    ...
    ConfidenceAwareSemanticRoute route(String message, ModerationResult deterministicResult) {
